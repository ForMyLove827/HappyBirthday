const birthdayData = {
  assetVersion: "videos-2026-08-27-1",
  girlName: "Любимая",
  hero: {
  ...
  reasons: [
    ...
    },
    {
      ...
      text: "Спасибо тебе за то, что ты есть, и за то, что рядом со мной.(Ну, почти рядом)"
    }
  ],
  lovedOnes: [
    {
  ...
  letter: [
    ...
    "Я тебя очень люблю, и хочу, чтобы ты знала это каждый день.",
  ],
  finale: [
    "Я надеюсь, что этот год подарит тебе всё, чего ты хочешь.",
    "А я постараюсь сделать всё,чтобы ты улыбалась как можно чаще.",
