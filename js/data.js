const birthdayData = {
  ...
  hero: {
    ...
    subtitle: "Сегодня я просто хочу напомнить тебе, насколько ты особенная для меня.",
    photo: "assets/photos/main.jpg",
    alt: "Портрет именинницы"
  },
  music: {
    autoplay: true,
  ...
  story: [
    {
      photo: "assets/photos/photo_24_2026-08-23_14-13-52.jpg",
    },
    {
      photo: "assets/photos/photo_13_2026-08-23_14-13-52.jpg",
    },
    {
      photo: "assets/photos/photo_27_2026-08-23_14-13-52.jpg",
    },
    {
      photo: "assets/photos/photo_30_2026-08-23_14-13-52.jpg",
    }
  ],
  reasons: [
    {
      title: "Твоя улыбка",
      text: "Она умеет менять весь день. Даже самый обычный момент рядом с тобой становится теплее."
    },
    {
      title: "То, как ты смеёшься",
      text: "В твоём смехе есть что-то настоящее, живое и очень родное."
    },
    {
      title: "Твоя забота",
      text: "Ты замечаешь мелочи, которые другие пропускают, и от этого рядом с тобой спокойно."
    },
    {
      title: "То, какой ты человек",
      text: "В тебе столько доброты, силы и света, что этим невозможно не восхищаться."
    },
    {
      title: "Наши разговоры",
      text: "С тобой можно говорить обо всём и молчать так, будто это тоже разговор."
    },
    {
      title: "Наши странные шутки",
      text: "Они только наши, и именно поэтому каждый раз кажутся ещё смешнее."
    },
    {
      title: "То, как рядом с тобой ощущается дом",
      text: "Не место, не стены, не город. Просто ты рядом, и всё становится на свои места."
    },
    {
  ...
  letter: [
    "Я долго думал, что написать здесь, потому что невозможно уместить всё в несколько предложений...",
    "Но я точно знаю одно: ты делаешь мою жизнь теплее, светлее и настоящей. Спасибо тебе за то, что ты рядом."
  ],
  finale: [
    "Я надеюсь, что этот год подарит тебе всё, чего ты хочешь.",
    "А я постараюсь сделать всё, чтобы рядом со мной ты улыбалась как можно чаще.",
